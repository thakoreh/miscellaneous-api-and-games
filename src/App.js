...
import JokeSection from './jokesection.js';
  ...
  return (
    <div className="App"  >
      <div >
        ...
        {/* <Navbar style={{backgroundColor:"black",height:"70px"}} >
          <NavbarBrand href="/" style={{color:"white"}}>Welcome to Miscellaneous API</NavbarBrand>
        </Navbar> */}
        <JokeSection />
